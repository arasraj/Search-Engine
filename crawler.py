...
class Crawler():
  ...
  def __init__(self):
    self.frontier = ['http://www.nfl.com']
    self.visited = []
    ...
    for i in range(depth):
      for j in range(size):
        ...
        try:
          ...
          conn.addheader = [('User-Agent', 'RajBot - School project. Email arasraj@gmail.com if behaving badly.' )]
...
if __name__ == '__main__':
  ...
  #print spider.robots_ex('http://www.fittidbit.com/')    import urllib
import urllib2
import hashlib
from urlparse import urljoin
from urlparse import urlparse
